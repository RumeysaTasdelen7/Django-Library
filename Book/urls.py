...
from .views import BookCreateView, BookListView, BookDetailView, BookUpdateView, BookDeleteView, PublisherListView, PublisherDetailView, AuthorListView, AuthorDetailView, AuthorCreateView, CategoryListView, CategoryDetailView
